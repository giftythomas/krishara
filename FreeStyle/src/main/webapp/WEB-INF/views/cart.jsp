...
<!-- check-out -->
<div class="check" data-ng-app="myApp" ng-controller="productCtrl">
	<div class="container">
		...
		<div class="col-md-9 cart-items">
			...
			<div class="cart-header" ng-repeat="roll in names">
				<div class="close1">
					<a href="deleteCartItem?id={{roll.product_id }}"><span
						class="glyphicon glyphicon-remove" aria-hidden="true"></span></a>
				</div>
				<div class="cart-sec simpleCart_shelfItem">
					<div class="cart-item cyc">
						<img src="resources/images/${roll.product_id}.jpg"
...
<script
	src="http://ajax.googleapis.com/ajax/libs/angularjs/1.4.2/angular.min.js"></script>
<div>
	<a href="<spring:url value="/user/cart" />" class="btn btn-primary"><span
